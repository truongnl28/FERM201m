...
class Menu extends Component {
      ...
      return (
        <Card>
          ...
          <div className="bg-[#FCF8E8] p-2">
            <div className="text-[#FCF8E8] font-semibold text-left mb-2">
              {dish.name}
            </div>
  ...
  renderDishComment(dish) {
    if (dish != null)
      return (
        <Card>
          <div className="bg-[#FCF8E8] text-[#DF7861] p-2 h-[565px] leading-relaxed">
          ...
          >
            <div className="relative flex items-center justify-center">
              <img
                ...
                alt={dish.name}
              />
              <div className="w-full absolute bottom-0 text-center bg-[#ECB390] text-white uppercase">
